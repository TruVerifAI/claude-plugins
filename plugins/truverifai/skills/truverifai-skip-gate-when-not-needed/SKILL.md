---
name: truverifai-skip-gate-when-not-needed
description: >
  ...
  hotfix. Calls `mcp__truverifai__record_gate_skip` with a structured
...
2. **Call `mcp__truverifai__record_gate_skip`** with:
