...
`agreement_score = 0.92` → strong consensus. Use the answer.
...
3. Move on. You spent 15-30 seconds + ~$0.04 to validate the choice; don't over-engineer the decision.
...
- High agreement_score on a canonical pattern is the expected case.
